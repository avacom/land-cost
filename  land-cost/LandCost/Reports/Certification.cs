...
namespace LandCost.Reports {
    ...
    public class Certification : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "LandCost.Reports.Certification.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCertification : Component, ICachedReport {
        
        public CachedCertification() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Certification rpt = new Certification();
            rpt.Site = this.Site;
            return rpt;
        }
